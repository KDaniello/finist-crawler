...
def test_full_data_lifecycle(base_dir: Path, file_lock):
    ...
    writer = DataWriter(base_dir=base_dir, session_id=session_id, source="test_forum", lock=file_lock)
...
def test_data_writer_no_data_returns_none(base_dir: Path, file_lock):
    writer = DataWriter(base_dir=base_dir, session_id="empty_session", source="ghost", lock=file_lock)
...
def test_data_writer_concurrent_batches(base_dir: Path, file_lock):
    writer = DataWriter(base_dir=base_dir, session_id="concurrent", source="test", lock=file_lock)
